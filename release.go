...
func buildAndZip(osname, arch string) error {
	...
	buildInfo := fmt.Sprintf("-X github.com/talkimhi/awless/config.buildDate=%s -X github.com/talkimhi/awless/config.buildSha=%s -X github.com/talkimhi/awless/config.buildOS=%s -X github.com/talkimhi/awless/config.buildArch=%s -X github.com/talkimhi/awless/config.BuildFor=%s",
